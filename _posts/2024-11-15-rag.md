...
The console prints out the 32 Q/A pairs to indicate that Spyder has properly read the file. The last of the pairs is shown below (all 32 were indeed printed in the console, as directed by the code):
