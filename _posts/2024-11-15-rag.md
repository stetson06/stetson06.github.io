...
With the virtual environment established, we proceed to coding on Python. Within the Spyder IDE, we ensure our working directory is pointing toward the folder containing the model's files. The
