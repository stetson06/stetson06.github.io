---
layout: post
title: Agentic AI - Building a SQL AI Agent and a Discussion on Employment of AI Agents
...
OpenAI is now allowing ChatGPT-5 (its latest version currently) to be used for agentic tasks, so we invoke it here. Temperature is the parameter for creativity/randomness, with 0 equating to completely consistent, deterministic/non-stochastic responses.
...
# A Quick Discussion on When to Use AI Agents (and When Not to Use Them)
